...
const availableBookIds = new Set(['gen', 'exo', 'num', 'jdg', '1ki', '1ch', 'ezr', 'psa', 'isa', 'lam', 'mat', 'mrk', 'luk', 'jhn', 'rom', 'gal', 'eph', 'php', '1th', '2th', '2ti', 'tit', 'phm', 'jas', '1pe', '2pe', '1jn', '2jn', '3jn', 'jud', 'rev'])
