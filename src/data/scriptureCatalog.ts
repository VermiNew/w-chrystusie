...
const availableBookIds = new Set(['gen', 'exo', 'lev', 'num', 'deu', 'jos', 'jdg', 'rut', '1sm', '2sm', '1ki', '2ki', '1ch', '2ch', 'ezr', 'neh', 'job', 'psa', 'pro', 'ecc', 'sng', 'isa', 'jer', 'lam', 'ezk', 'hos', 'jol', 'amo', 'oba', 'jon', 'mic', 'nah', 'hab', 'zep', 'hag', 'zec', 'mal', 'mat', 'mrk', 'luk', 'jhn', 'act', 'rom', '1co', '2co', 'gal', 'eph', 'php', 'col', '1th', '2th', '1ti', '2ti', 'tit', 'phm', 'heb', 'jas', '1pe', '2pe', '1jn', '2jn', '3jn', 'jud', 'rev'])
